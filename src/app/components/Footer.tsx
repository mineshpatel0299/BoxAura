...
export default function Footer() {
  ...
  return (
    <footer ref={ref} className="relative mt-10">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-14 sm:pt-20 pb-8">
        {/* Main footer grid */}
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-8">
          ...
          >
            ...
            <p className="text-sm text-stone-400 leading-relaxed font-light max-w-xs mb-5">
            ...
            <div className="flex items-center gap-2.5">
              {SOCIALS.map((social) => (
                <a
                  ...
                  className="w-8 h-8 rounded-full border border-stone-200 flex items-center justify-center text-stone-400 hover:border-pink-300 hover:text-pink-400 transition-all duration-300"
                >
                  {social.icon}
                </a>
              ))}
          ...
          >
            <h4 className="font-heading text-[11px] uppercase tracking-[0.2em] text-stone-700 mb-4">
              Quick Links
            </h4>
            <ul className="space-y-2.5">
              {QUICK_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-xs sm:text-sm text-stone-400 hover:text-pink-400 transition-colors duration-300 font-light"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          >
            ...
            >
              <input
                ...
                className="flex-1 min-w-0 rounded-full border border-stone-200 bg-transparent px-4 py-2.5 text-xs sm:text-sm text-stone-600 placeholder:text-stone-300 outline-none focus:border-pink-300 transition-colors duration-300"
              />
              <button
                type="submit"
                className="shrink-0 rounded-full bg-stone-800 px-5 py-2.5 font-heading text-[10px] uppercase tracking-[0.2em] text-white hover:bg-pink-400 transition-all duration-500"
              >
                Go
              </button>
            </form>
        ...
        <motion.div
          ...
          className="mt-10 pt-6 border-t border-stone-100 flex flex-col sm:flex-row items-center justify-between gap-2"
        >
