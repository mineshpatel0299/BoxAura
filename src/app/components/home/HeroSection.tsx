    ...
    <section className="relative w-full min-h-[100svh] flex flex-col items-center justify-center overflow-hidden bg-stone-950 pt-14 sm:pt-20 lg:pt-28 pb-4 sm:pb-8">
      ...
      <AnimatePresence initial={false}>
        ...
        >
          ...
          <div className="absolute inset-0 bg-stone-950/40 backdrop-blur-[4px]" />
          <div className="absolute inset-0 bg-gradient-to-t from-stone-950/80 via-transparent to-stone-900/30" />
        </motion.div>
      </AnimatePresence>

      <div className="relative z-10 w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12 flex-1 flex flex-col items-center justify-between sm:justify-center gap-6 sm:gap-0">
        ...
        <div className="text-center sm:mb-10 lg:mb-12">
          <motion.p
            ...
            className="text-stone-400 uppercase tracking-[0.3em] sm:tracking-[0.5em] text-[8px] sm:text-[10px] md:text-[11px] mb-3 sm:mb-8 font-light"
          >
            BoxAura Unveiled
          </motion.p>
          <motion.h1
            ...
            className="text-[2.2rem] sm:text-5xl md:text-6xl lg:text-[6rem] font-heading text-white font-light leading-[1.05] tracking-tight"
          >
            The Art of <br />
        ...
        {/* Cube + Description + Hint — grouped together */}
        <div className="flex flex-col items-center">
          {/* Cube Container */}
          <div className="relative w-full flex flex-col items-center justify-center sm:mb-12 lg:mb-16">
            <motion.div
          ...
          <motion.div
             ...
             className="mt-3 sm:mt-0 sm:absolute sm:-bottom-10 text-stone-500 text-[8px] sm:text-[9px] uppercase tracking-[0.3em] flex items-center gap-2 sm:gap-3 pointer-events-none"
          >
            <span className="w-6 sm:w-10 h-px bg-stone-700" />
            Click to rotate
            <span className="w-6 sm:w-10 h-px bg-stone-700" />
          </motion.div>

          {/* Description — below cube on mobile only */}
          <motion.p
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.5, duration: 0.8 }}
            className="text-stone-400 text-[11px] sm:hidden text-center px-4 font-light leading-relaxed max-w-[280px] mx-auto mt-4"
          >
        ...
        {/* Bottom CTA */}
        <div className="w-full flex flex-col items-center text-center text-white pb-2 sm:pb-0">
          <motion.div
             initial={{ opacity: 0, y: 20 }}
             animate={{ opacity: 1, y: 0 }}
          ...
          >
            <a href="/premium-wedding-invitation" className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/5 backdrop-blur-sm text-white px-6 py-3 sm:px-10 sm:py-4 text-[8px] sm:text-[10px] uppercase tracking-[0.25em] sm:tracking-[0.3em] hover:bg-white hover:text-stone-950 transition-all duration-500 w-max">
               Explore Collection
            </a>
          </motion.div>
        </div>
